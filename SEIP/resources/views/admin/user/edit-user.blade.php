                        ...
                        <form action="{{route('users.update', $user->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input class="form-control" id="Email" name="email" placeholder="Email" value="{{$user->email}}" disabled type="email" />
                            ...
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control" id="Password" name="old_password"  type="password" placeholder="Password" />
